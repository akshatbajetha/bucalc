...
export default function Navbar() {
  ...
  return (
    <>
      <header className="flex h-20 w-full shrink-0 items-center px-4 md:px-6 overflow-hidden">
        <Sheet>
          ...
          <SheetContent side="left">
            <Link href="/" className="mr-6 lg:flex" prefetch={false}>
              <Image
                className="main-logo dark:invert-0 invert"
                src={MainLogo}
                alt="Logo"
              />
            </Link>
        ...
        <Link href="/" className="mr-6 lg:flex" prefetch={false}>
          <Image
            className="main-logo invert dark:invert-0"
            src={MainLogo}
            alt="Logo"
          />
        </Link>
